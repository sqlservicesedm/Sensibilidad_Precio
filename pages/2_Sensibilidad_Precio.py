...
df_ventas = pd.read_csv('data/ventas_para_elasticidad.csv')
df_inventario = pd.read_csv('data/inventario_para_elasticidad.csv')
df_despacho = pd.read_csv('data/despacho_para_elasticidad.csv')

df_recomendacion = pd.read_csv('data/recomendacion_rango_precios.csv')
...
probabilidades = pd.read_csv('data/Probabilidades_Ventas.csv', dtype={'SKU': str, 'cmitems_codbarra_principal': str})
